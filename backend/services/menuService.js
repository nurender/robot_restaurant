...
class MenuService {
    ...
    async createMenuItem(data) {
        const { restaurant_id, name, category, price, description, image_url, video_url, is_active } = data;
        const id = 'm' + Date.now();
    ...
    async updateMenuItem(id, data) {
        const { name, category, price, description, image_url, video_url, is_active } = data;
        await pool.query(
