        ...
        <table className="ext-cls-d8915f8c">
          ...
          <tbody>
            ...
            return <React.Fragment key={res.id}>
                    ...
                    <td className="ext-cls-b65a50f4">
                      <div className="ex-style-11a32e">
                        ...
                        setShowStaffPopup(true);
                          ...
                          {nodeStaff.length > 0 && <button onClick={() => toggleExpand(res.id)} style={{
                        display: 'flex',
                        alignItems: 'center',
                        gap: '4px',
                  ...
                  {isExpanded && nodeStaff.length > 0 && <tr>
                      <td colSpan="4" className="ext-cls-9ba1fd4d ex-style-1db3ca">
                        <div className="glass-panel ex-style-f92e88">
